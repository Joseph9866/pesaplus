    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="fixed top-0 left-0 right-0 bg-white z-50 px-4 py-4 border-b border-neutral-200">
        <div className="max-w-[428px] mx-auto flex items-center justify-between">
          ...
          <h1 className="text-lg font-medium text-[#0F2A44]">Step 1 of 4</h1>
          <div className="w-6" />
        </div>
      </div>
      ...
      <div className="flex-1 pt-28 pb-24 px-6 overflow-y-auto">
        <div className="max-w-[428px] mx-auto">
          <h2 className="text-2xl font-semibold text-[#0F2A44] mb-2">Personal Information</h2>
          <p className="text-sm text-[#6B7280] mb-6">Please provide your details as they appear on your ID</p>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-[#0F2A44] mb-1">First Name</label>
              <input
                type="text"
                placeholder="Enter your first name"
                className="w-full px-4 py-3 rounded-lg border border-neutral-300 focus:outline-none focus:ring-2 focus:ring-[#0F2A44] focus:border-transparent"
                {...register('firstName')}
              />
              {errors.firstName && (
            ...
            <div>
              <label className="block text-sm font-medium text-[#0F2A44] mb-1">Last Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[#0F2A44] mb-1">Date of Birth</label>
            ...
            <div>
              <label className="block text-sm font-medium text-[#0F2A44] mb-1">National ID Number</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[#0F2A44] mb-1">Residential Address</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[#0F2A44] mb-1">City</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-[#0F2A44] mb-1">Postal Code</label>
              <input
                type="text"
            ...
            <div className="bg-[#F4F6F8] rounded-lg p-3 flex items-start gap-2">
              ...
              <p className="text-xs text-[#6B7280]">This information must match your ID document</p>
            </div>
          </form>
        </div>
      </div>
