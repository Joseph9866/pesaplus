    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="fixed top-0 left-0 right-0 bg-white z-50 px-4 py-4 border-b border-neutral-200">
        <div className="max-w-[428px] mx-auto flex items-center justify-between">
          ...
          <h1 className="text-lg font-medium text-[#0F2A44]">Step 2 of 4</h1>
          <div className="w-6" />
        </div>
      </div>
      ...
      <div className="flex-1 pt-28 pb-24 px-6 overflow-y-auto">
        <div className="max-w-[428px] mx-auto">
          <h2 className="text-2xl font-semibold text-[#0F2A44] mb-2">Upload ID Document</h2>
          <p className="text-sm text-[#6B7280] mb-6">Please upload a clear photo of your National ID, Passport, or Driver's License</p>
          ...
          <div className="bg-[#F4F6F8] rounded-xl p-4 mt-6">
            <p className="text-sm font-medium text-[#0F2A44] mb-2">Tips for a clear photo:</p>
          ...
          <div className="bg-[#F4F6F8] rounded-lg p-3 flex items-start gap-2 mt-4">
            ...
            <p className="text-xs text-[#6B7280]">Your document will be securely stored and only used for verification purposes</p>
          </div>
        </div>
      </div>
